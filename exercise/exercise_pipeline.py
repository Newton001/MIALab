...
def collect_image_paths(data_dir):
    ...
    crawler_ = futil.FileSystemDataCrawler(data_dir, image_keys, dir_filter, MyFilePathGenerator())
...
def register_images(image_dict, atlas_img):
    ...
    registered_t1 = registration.execute(image_dict[structure.BrainImageTypes.T1w], registration_params).transformed_image
    ...
    registered_gt = sitk.Resample(gt_img, atlas_img, registration_params.transform, sitk.sitkNearestNeighbor)
